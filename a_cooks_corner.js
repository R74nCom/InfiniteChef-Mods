...
addRecipe("eel+flour","fried eel");//flowers
...
addRecipe("&plate:red_cabbage+radish+tomato_sauce","red plate");

addRecipe("&plate:eggplant+parmesan+tomato_sauce","eggplant parmesan");

addRecipe("&bowl:rice+sugar","rice pudding");

addRecipe("&plate:blueberry+sugar+bread","blueberry tart");
